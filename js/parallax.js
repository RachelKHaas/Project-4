/* resize the image(s) on page load */
	...
	function resize_all_parallax() {
		...
		var img_h = 590; /* the height of your image, in pixels */
	...
	function resize_parallax(div_id,img_w,img_h) {
		...
		if (divwidth < 1310) { var pct = (img_h/img_w) * 105; } /* show full image, plus a little padding, if on static mobile view */
